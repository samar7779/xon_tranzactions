...
export class AgentService {
  ...
  async tgArizaList(auth: Record<string, any>, opts: { status?: any; q?: string; submitter?: string; actorType?: any; page?: number }) {
    await this.authorizeTg(auth);
    return this.correction.listArizalar(opts);
  }
  async arizaList(key: string, opts: { status?: any; q?: string; submitter?: string; actorType?: any; page?: number }) {
    await this.assertKey(key);
    return this.correction.listArizalar(opts);
  }
