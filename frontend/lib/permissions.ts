...
export const PERMS = {
  ...
  DASHBOARD_KPI_BALANCE: 'dashboard:kpi_balance',
  DASHBOARD_KPI_ACCOUNTS: 'dashboard:kpi_accounts',
  DASHBOARD_KPI_BANKS: 'dashboard:kpi_banks',
  DASHBOARD_KPI_INFLOW: 'dashboard:kpi_inflow',
  DASHBOARD_KPI_OUTFLOW: 'dashboard:kpi_outflow',
  DASHBOARD_KPI_TXN: 'dashboard:kpi_txn',
  DASHBOARD_OBJECTS: 'dashboard:objects',
  DASHBOARD_DAILY: 'dashboard:daily',
  DASHBOARD_DAILY_BAR: 'dashboard:daily_bar',
  DASHBOARD_CLIENT: 'dashboard:client',
  DASHBOARD_XONPAY: 'dashboard:xonpay',
  DASHBOARD_TOP_ACCOUNTS: 'dashboard:top_accounts',
  ...
  OPLATAKV_BULK_SPLIT: 'oplatakv:bulk_split',      // Ommaviy Оплата turi
